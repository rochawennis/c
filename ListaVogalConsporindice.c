...
main(){
	char dado[30];
	int i, tam;
	char dado_remove[30],dado_busca[30];
    ...
    scanf("%c", &dado_remove[i]);
    if (dado_remove[i]=='a' || dado_remove[i]=='e' || dado_remove[i]=='i' || dado_remove[i]=='o' || dado_remove[i]=='u'){
		retorno_retira = retirar_vogal(inicio_vogal,dado_remove[i]);
		
    }
	else if (dado_remove[i]!=' ' && dado_remove[i]!='@' && dado_remove[i]!='#' && dado_remove[i]!='%' && dado_remove[i]!='&' && dado_remove[i]!='*' && dado_remove[i]!='(' && dado_remove[i]!=')'){
		retorno_retira = retirar_cons(inicio_cons,dado_remove[i]);
